...
//            stopSelf();
    ...
    protected void setupViews() {
        ...
        expandableView = inflater.inflate(R.layout.activity_hi_activty, null);
...
//        windowManager.addView(expandableView, expandableParams);
        ...
        //CardView card = (CardView) expandableView.findViewById(R.id.);
...
//        }
     ...
     * @param expanded the expanded view
     */
