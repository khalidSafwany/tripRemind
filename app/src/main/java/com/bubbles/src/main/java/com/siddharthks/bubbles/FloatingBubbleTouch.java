...
import com.example.tripremainder.HiActivty;
...
public class FloatingBubbleTouch implements View.OnTouchListener {
    ...
    public void setState(boolean state) {
        ...
        if (expanded) {
            if(!isOn) {
                Intent intent = new Intent(context, HiActivty.class);
    ...
    public static final class Builder {
        ...
        public FloatingBubbleTouch build(Context context) {
             FloatingBubbleTouch.context = context;
